...
const About = () => {
    return (
    <div id='about' className={`${classes.container} bg-primary-darkBlue text-2xl lg:text-5xl overflow-hidden hover:cursor-pointer`}>
        <div className={`${classes['rotating-box']}`}>
            ...
            <h2 className={`${classes.heading} overflow-hidden text-2xl lg:text-5xl`}>About Me..</h2>
