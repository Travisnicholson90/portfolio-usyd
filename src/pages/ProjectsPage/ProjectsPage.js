...
<div scrollToProjects={scrollToProjects} id='projects' className={`${classes.container}`}>
    <div className={`${classes.main}`}>
        ...
        <div className={`${classes.wrapper} bg-primary-darkGreen`}>
                <div className={`${classes.links} px-8 text-md lg:text-2xl  bg-primary-darkGreen`}>
                    <a className='hover:cursor-pointer' href="https://github.com/Travisnicholson90/book-search-engine-usyd" target='blank'>
                    <p className='text-primary-lime'>GitHub</p>
                    </a>
                    <a className='hover:cursor-pointer' href="https://google-books-search-app-08a6074e8894.herokuapp.com/">
                    <p className='text-primary-lime'>Website</p>
                    </a>
                </div>
                <div className={`${classes.title}  bg-primary-darkGreen text-primary-Pink`}>
                    <h2 className='overflow-hidden text-2xl lg:text-5xl text-center'>Google Book Search</h2>
                </div>
        ...
        <div className={`${classes.wrapper} bg-primary-grayishWhite`}>
                <div className={`${classes.links} px-8 text-md lg:text-2xl  bg-primary-grayishWhite`}>
                    <a className='hover:cursor-pointer' href="https://github.com/Travisnicholson90/kickz-shoe-store">
                    <p className='text-primary-red'>GitHub</p>
                    </a>
                    <a className='hover:cursor-pointer' href="https://kickz-ecommerce-store-87d5ac8dc576.herokuapp.com/">
                    <p className='text-primary-red'>Website</p>
                    </a>
                </div>
                <div className={`${classes.title}  bg-primary-grayishWhite text-primary-brightPeach`}>
                    <h2 className='overflow-hidden text-2xl lg:text-5xl text-center'>Kicks e-commerce</h2>
                </div>
    ...
    <div ref={shoesRef} className={`overflow-hidden p-4  ${classes.planner} bg-primary-darkBlue ${shoesInView ? `${classes['show-shoes']}` : `${classes['hide-shoes']}`}`}>
        <div className={`${classes.wrapper} bg-primary-darkBlue`}>
                ...
                <a className='hover:cursor-pointer' href="https://github.com/Travisnicholson90/quiz-app" target='blank'>
                ...
                <div className={`${classes.title}  bg-primary-darkBlue text-primary-Pink`}>
                    <h2 className='overflow-hidden text-2xl lg:text-5xl text-center'>TechStack Quiz</h2>
                </div>
